...
static void expandMemMoveAsLoop(MemMoveInst *Memmove) {
...
class LowerMemIntrinsics : public llvm::ModulePass {
public:
  static char ID;
  LowerMemIntrinsics() : llvm::ModulePass(ID) {}
...
static RegisterPass<LowerMemIntrinsics> X("fuzzalloc-lower-mem-intrinsics",
                                          "Lower memory intrinsics", false,
                                          false);
